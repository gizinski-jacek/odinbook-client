	...
	return (
		<div className={styles.right}>
			<ul className={styles.user_controls}>
				...
				>
					<span
						className={`${styles.icon} ${openMenuId === 1 ? 'btn-active' : ''}`}
					>
				...
				>
					<span
						className={`${styles.icon} ${openMenuId === 2 ? 'btn-active' : ''}`}
					>
				...
				>
					<span
						className={`${styles.icon} ${openMenuId === 3 ? 'btn-active' : ''}`}
					>
						<svg viewBox='0 0 28 28' height='20' width='20'>
				...
				>
					<span
						className={`${styles.icon} ${openMenuId === 4 ? 'btn-active' : ''}`}
					>
